...
const members: GroupMember[] = [
  {
    ...
    courses: [
      { title: "Nhập môn Lập trình", progressPercent: 86 },
      { title: "Cấu trúc Dữ liệu & Giải thuật", progressPercent: 58 },
    ],
    achievements: [
  ...
  },
  {
    ...
    courses: [{ title: "Java Core", progressPercent: 74 }, { title: "Thuật toán cơ bản", progressPercent: 62 }],
    achievements: [
  ...
  },
  {
    ...
    courses: [{ title: "Nhập môn Lập trình", progressPercent: 46 }, { title: "JavaScript cơ bản", progressPercent: 31 }],
    permissionOverrides: { createExercise: true },
    achievements: [
  ...
  },
  {
    ...
    courses: [{ title: "Nhập môn Lập trình", progressPercent: 68 }, { title: "Lập trình hướng đối tượng", progressPercent: 42 }],
    permissionOverrides: { createExercise: false },
    achievements: [
  ...
  },
  {
    ...
    technologies: ["C", "Git"],
    courses: [{ title: "Nhập môn Lập trình", progressPercent: 25 }],
    achievements: [
...
const exercises: GroupExercise[] = [
  {
    ...
    authorId: "trung-nguyen",
    authorName: "Nguyễn Trung Nguyên",
    createdAt: "16/07/2026",
    constraints: ["0 ≤ |a|, |b|, |c| ≤ 10⁶", "Làm tròn kết quả đến 2 chữ số thập phân"],
    hints: ["Tách riêng trường hợp a = 0 trước khi tính delta.", "So sánh số thực với epsilon thay vì dùng ==."],
  },
  {
    ...
    authorId: "gia-si",
    authorName: "Nguyễn Trần Gia Sĩ",
    createdAt: "18/07/2026",
    constraints: ["1 ≤ n ≤ 10⁵", "Giá trị mỗi phần tử nằm trong khoảng -10⁶ đến 10⁶"],
    hints: ["Khởi tạo biến tổng bằng 0.", "Duyệt từng phần tử đúng một lần."],
  },
  {
    ...
    constraints: ["2 ≤ n ≤ 10⁹", "Ưu tiên độ phức tạp O(√n)"],
    hints: ["Không cần thử tất cả các số nhỏ hơn n.", "Nếu n có ước lớn hơn √n thì sẽ có một ước nhỏ hơn √n."],
  },
  {
    ...
    constraints: ["Số node không vượt quá 10⁵", "Không dùng mảng phụ để đảo danh sách"],
    hints: ["Lưu node kế tiếp trước khi đổi liên kết.", "Duy trì ba con trỏ prev, current và next."],
  },
  {
    id: "xoay-mang",
    ...
    refDoc: "",
    authorId: "Trợ lý AI",
    authorName: "Trợ lý AI · duyệt bởi Gia Sĩ",
    createdAt: "26/07/2026",
    constraints: ["1 ≤ n ≤ 10⁵", "0 ≤ k ≤ 10⁹", "Dùng bộ nhớ phụ O(1)"],
    hints: ["Rút gọn k bằng phép chia dư cho n.", "Thử phương pháp đảo ba lần."],
  },
  {
    id: "chuoi-ngoac-hop-le",
    ...
    assignedCount: 0,
    completedCount: 0,
    objective: "Kiểm tra một biểu thức chỉ gồm (), [] và {} có được đóng/mở đúng thứ tự hay không.",
    estTime: "25 phút",
    sampleInput: "{[()]}",
    sampleOutput: "Hợp lệ",
    criteria: "Đúng toàn bộ test · Độ phức tạp O(n) · Không dùng đệ quy.",
    phase: "Đề xuất bổ sung — Stack & Chuỗi",
    refDoc: "",
    authorId: "van-b",
    authorName: "Trần Văn B",
    createdAt: "24/07/2026",
    reviewRequestedAt: "24/07/2026 20:32",
    reviewerName: "Nguyễn Trần Gia Sĩ",
    creatorNote: "Mình muốn thêm bài này sau buổi học về stack để cả nhóm luyện tư duy ghép cặp.",
    supportLanguages: ["C++", "Java", "JavaScript", "Python"],
    testCaseCount: 14,
    timeLimit: "1 giây",
    memoryLimit: "128 MB",
    constraints: ["0 ≤ độ dài chuỗi ≤ 10⁵", "Chuỗi chỉ chứa các ký tự ngoặc hợp lệ"],
    hints: ["Lưu ngoặc mở vào stack.", "Mỗi ngoặc đóng phải khớp phần tử trên đỉnh stack."],
  },
];
...
const assignments: Assignment[] = [
  ...
  {
    id: "a-10",
    exerciseId: "xoay-mang",
    memberId: "gia-si",
    status: "done",
    reviewStatus: "approved",
    feedback: "Cách đảo ba lần rõ ràng, xử lý đúng trường hợp k lớn hơn n.",
    submissions: [
      { version: 1, submittedAt: "23/07/2026 21:18", result: "Đạt", detail: "8/8 kiểm thử · O(n), O(1) bộ nhớ", isLate: false },
    ],
  },
];
