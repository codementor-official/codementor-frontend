...
export function ResizeHandle({ orientation }: { orientation: "horizontal" | "vertical" }) {
  ...
  return (
    <Separator
      className={`group relative shrink-0 bg-muted transition-colors ${
    ...
    >
      ...
      <span
        className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-muted-foreground transition-colors group-hover:bg-primary ${
